...
<body>
    ...
    <div id="builder">
        ...
        <div class="container">
          ...
          <div class="primary-controls pull-right">
        		
        		<div class="select select-setting btn-group">           
                  ...
                  <span class="filter-option">Settings</span>
              ...
              <a href="#previewModal" data-toggle="modal" class="btn btn-inverse preview-btn btn-embossed pull-right" style="margin-right: 1px; display: none" id="buttonPreview"><span class="fui-window"></span> <?php echo $this->lang->line('actionbuttons_preview')?></a>
								        	
          		
          		
          		<a href="#" id="publishPage" class="btn btn-inverse btn-embossed actionButtons"  ><span class="fui-upload"></span> <?php echo $this->lang->line('actionbuttons_publish')?> <span class="fui-alert-circle text-danger" <?php if( $siteData['site']->ftp_ok == 1 ):?>style="display:none"<?php endif;?>></span></a>

                <a href="#exportModal" id="exportPage" data-toggle="modal" class="btn btn-info btn-embossed btn-exprort actionButtons" style="margin-right: 1px; display: none"><span class="fui-export"></span> <?php echo $this->lang->line('actionbuttons_export')?></a>
                
                <div class="btn-group revision-group" style="float: right; margin-right: 10px; display: none" id="button_revisionsDropdown">           
    					<button class="btn btn-inverse btn-embossed <?php if( !$revisions ):?>disabled<?php endif;?>"><span class="fui-windows"></span> <span class="bLabel"><?php echo $this->lang->line('actionbuttons_versions')?></span></button>
    					<button class="btn btn-inverse btn-embossed dropdown-toggle <?php if( !$revisions ):?>disabled<?php endif;?>" data-toggle="dropdown">
    						<span class="caret"></span>
    					</button>
    					<span class="dropdown-arrow dropdown-arrow-inverse"></span>
                ...
                <?php if( $this->ion_auth->is_admin() ):?>
            		<div class="btn-group save-btn-group" style="float: right; margin-right: 10px;">        
                   ...
                   <span class="fui-check"></span>
                      <span class="bLabel"><?php echo $this->lang->line('actionbuttons_save')?></span>
            		  	...
            		  	<span class="dropdown-arrow dropdown-arrow-inverse"></span>
            		  	<ul class="dropdown-menu dropdown-menu-inverse">
                      <li><a href="#" id="savePage" data-toggle="modal"><span class="fui-arrow-right"></span> <?php echo $this->lang->line('actionbuttons_savesite')?></a></li>
        		...
        		<div class="modes" id="siteBuilderModes">
        			...
        			<label class="radio primary first" id="modeElementsLabel" data-toggle="tooltip" data-placement="bottom"  >
                ...
                <span class="tooltip-item">
                      ...
                      <span class="tooltip-content clearfix">
                        <span class="tooltip-text">
                           <p class="tooltip__header">Use this mode to:</p>
                           <ul class="tooltip__list">
                             <li>- Drag &amp; drop elements from the sidebar stock to the canvas;</li>
                             <li>- Remove, reset or reorder elements which were added to the canvas before;</li>
                             <li>- View and edit source HTML code of the elements.</li>
                           </ul>
                        </span>
                      </span>
        			</label>
        			<label class="radio primary first" id="modeContentLabel" data-toggle="tooltip" data-placement="bottom" style="display: none">
                  ...
                  <span class="tooltip-item">
                      ...
                      <span class="tooltip-content clearfix">
                        <span class="tooltip-text">
                           <p class="tooltip__header">Use this mode to:</p>
                           <ul class="tooltip__list">
                             <li>- Edit written content on your pages, pasting or typing your own text.</li>
                           </ul>
                        </span>
                      </span>
        			</label>
        			<label class="radio primary first" id="modeStyleLabel" data-toggle="tooltip" data-placement="bottom" style="display: none">
                  ...
                  <span class="tooltip-item">
                      ...
                      <span class="tooltip-content clearfix">
                        <span class="tooltip-text">
                           <p class="tooltip__header">Use this mode to:</p>
                           <ul class="tooltip__list">
                             <li>- Edit text color and size, change font-family;</li>
                             <li>- Choose different icons;</li>
                             <li>- Edit certain style attributes, images, links and videos.</li>
                           </ul>
                           </ul>
                        </span>
                      </span>
        	...
        	<div class="screen" id="screen">
        		...
        		<div class="toolbar">
        			...
        			<div class="title">
        				<span id="pageTitle">index</span>.html
        			</div>
                ...
                <span><span class="highlight">Build your page</span> by dragging elements from the toolbar on the left</span>
              </div>
        		</div>
        ...
        <div id="styleEditor" class="styleEditor">
            ...
            <li style="display: none;"><a href="#audio_Tab" id="audio_Link"><span class="fa "></span> Audio </a></li>
     		</ul><!-- /tabs -->
        	...
        	<div class="sideButtons clearfix">
        		...
        		<button type="button" class="btn btn-info btn-embossed btn-xs" id="resetStyleButton"><i class="fa fa-refresh"></i> <?php echo $this->lang->line('sidebuttons_apply_reset')?></button>
        	...
        	<div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Success!</h4>
          		...
          		<div class="modal-body">
          			<p>Now, you are safe, no worries! <br> Your site has been saved successfuly.</p>       	          				        	
          		</div><!-- /.modal-body -->
          			      		
          		<div class="modal-footer modal-footer-empty">
            		<button type="button" class="btn btn-primary" data-dismiss="modal"><?php echo $this->lang->line('modal_close')?></button>
          		</div>
    	...
    	<div class="modal-dialog">
        	...
        	<div class="modal-content">
          		...
          		<div class="modal-body">
    				...
    				<p>
    					You’ve got <strong>pending changes</strong>! If you leave this page your changes will be lost. Do you want to leave this page?
    				</p>
          				        	
          		</div><!-- /.modal-body -->
          			      		
          		<div class="modal-footer modal-footer-empty">
            		<button type="button" class="btn btn-primary" data-dismiss="modal"><span class="fui-cross"></span> <?php echo $this->lang->line('modal_pendingchanges_button_stay')?></button>
            		<a href="<?php echo site_url('sites')?>" class="btn btn-danger btn-embossed" id="leavePageButton"><span class="fui-check"></span> <?php echo $this->lang->line('modal_pendingchanges_button_leave')?></a>
          		</div>
		...
		<div class="modal-dialog">
	    	<div class="modal-content">
	      		...
	      		<div class="modal-footer">
	        		...
	        		<button type="button" type="button" class="btn btn-info btn-embossed" id="updateContentInFrameSubmit"><?php echo $this->lang->line('modal_editcontent_updatecontent')?></button>
	      		</div>
	    	</div><!-- /.modal-content -->
	  	</div><!-- /.modal-dialog -->
	...
	<div class="modal fade" id="previewModal" tabindex="-1" role="dialog" aria-hidden="true">
		...
		<div class="modal-dialog">
	    	...
	    	<div class="modal-content">
	      		...
	      		<div class="modal-footer modal-footer-empty">
	        		<button type="button" class="btn btn-primary btn-embossed" data-dismiss="modal"><span class="fui-cross"></span> <?php echo $this->lang->line('modal_cancelclose')?></button>
					<button type="submit" class="btn btn-info btn-embossed"><span class="fui-export"></span>Open Preview</button>
	      		</div>
