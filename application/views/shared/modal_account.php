    	...
    	<div class="modal-content">
      		...
      		<div class="modal-footer">
        		<button type="button" class="btn btn-primary" data-dismiss="modal"> <?php echo $this->lang->line('modal_cancelclose')?></button>
      			<button type="button" class="btn btn-warning btn-embossed accountDetailsSubmit" id="accountDetailsSubmit"><span class="fui-check"></span> <?php echo $this->lang->line('account_button_updatedetails')?></button>
      		</div>
