			...
			<div class="modal-dialog">
		    	...
		    	<div class="modal-content">
		      		...
		      		<div class="modal-footer modal-footer-empty">
		        		...
		        		<a href="" type="button" class="btn btn-primary" id="deleteUserButton"><?php echo $this->lang->line('imsure')?></a>
		      		</div>
			...
			<div class="modal-dialog">
		    	...
		    	<div class="modal-content">
		      		...
		      		<div class="modal-footer">
		        		...
		        		<button type="button" class="btn btn-warning" id="buttonCreateAccount"><?php echo $this->lang->line('users_modal_newuser_button_create')?></button>
		      		</div>
