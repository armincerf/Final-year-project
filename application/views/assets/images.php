      ...
      <div class="container-fluid">
      	...
      	<div class="row">
      		...
      		<div class="col-md-12">
      		    ...
      		    <h1 class="page-name"><?php echo $this->lang->line('images_heading')?></h1>
      	...
      	<div class="row">
      		...
      		<div class="col-md-9 image-stack">
    						...
    						<?php if( isset($userImages) ):?>
    							...
    							<div class="image">
    								...
    								<div class="buttons clearfix">
    									...
    									<button type="button" id="deleteImageButton" class="btn btn-danger btn-embossed btn-sm" data-img="<?php echo base_url().$this->config->item('images_uploadDir');?>/<?php echo $userID;?>/<?php echo $img;?>"><span class="fui-trash"></span> <?php echo $this->lang->line('images_button_delete')?></button>
    								</div>
      					...
      					<div class="images masonry-3" id="adminImages">
      						...
      						<?php if( isset($adminImages) ):?>
      							...
      							<div class="image">
      								...
      								<div class="buttons clearfix">
      									<button type="button" class="btn btn-primary btn-embossed btn-sm"><span class="fui-export"></span> view image</button>
      								</div>
  		...
  		<div class="modal-dialog modal-lg">
  	    	...
  	    	<div class="modal-content">
  	      		...
  	      		<div class="modal-footer">
  	        		<button type="button" class="btn btn-primary" data-dismiss="modal"><span class="fui-cross"></span> <?php echo $this->lang->line('modal_close')?></button>
  	      		</div>
  	...
  	<div class="modal fade deleteImageModal" id="deleteImageModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  		...
  		<div class="modal-dialog">
  	    	...
  	    	<div class="modal-content">
  	      		...
  	      		<div class="modal-footer">
  	        		<button type="button" class="btn btn-primary" data-dismiss="modal"><span class="fui-cross"></span> <?php echo $this->lang->line('cancel')?></button>
  	        		<button type="button" class="btn btn-warning" id="deleteImageButton"><span class="fui-check"></span> <?php echo $this->lang->line('modal_deleteimage_button_delete')?></button>
  	      		</div>
