...
class Users extends MY_Controller {
	...
	*/
	...
	public function rpw($userID = '') {
		...
		if( $userID == '' || $userID == 'undefined' ) {
			...
			$temp = array();
			$temp['header'] = "Something went wrong:";
	...
	*/
	...
	public function enable($userID) {
		...
		$this->session->set_flashdata('success', "The user account has been activated.");
	...
	*/
	...
	public function disable($userID) {
		...
		$this->session->set_flashdata('success', "The user account has been de-activated.");
