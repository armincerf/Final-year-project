...
class Sites extends MY_Controller {
	...
	*/
	...
	/*
		...
		creates new site and loads builder
	...
	*/
	...
	/*
		...
		Used to create new site after loading template AND save existing ones
	...
	*/
    ...
    /*
        ajax call; sets configuration data
    */
	...
	*/
	...
	public function site($siteID) {
		...
		//if user is not an admin, check site belongs to this user
	...
	*/
	...
	public function siteAjaxUpdate() {
		...
		if ($this->form_validation->run() == FALSE) {
			...
			//send back the updated site data
