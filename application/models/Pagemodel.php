...
class Pagemodel extends CI_Model {
    ...
    /*
    	...
    	get page metadata for an entire site
    ...
    */
    ...
    /*
    	...
    	retrieves metadata for single page, using the siteID and page name
    ...
    */
    ...
    public function makeFromTemplate($siteID){
	...
	*/
	...
	public function saveTemplate( $siteData, $contents = '', $templateID = 0 ) {
		...
		if( $templateID == 0 ) {//create new template
